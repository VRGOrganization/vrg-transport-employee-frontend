...
export function EmployeeAdminHeader() {
  return (
    <header className="relative bg-primary pt-16 pb-24 px-6 overflow-hidden">
      <div className="absolute top-0 right-0 size-64 bg-primary-container/20 rounded-full -mr-20 -mt-20 blur-3xl" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <div className="size-16 bg-surface-container-lowest/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 shadow-xl border border-surface-container-lowest/20">
