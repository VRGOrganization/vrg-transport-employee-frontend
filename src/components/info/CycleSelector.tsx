...
export function CycleSelector({
  ...
  return (
    <Dropdown
      menuClassName="w-96 p-1.5 ring-0 border border-outline-variant shadow-none [box-shadow:var(--shadow-modal)]"
      trigger={(open) => (
        <button
          type="button"
    ...
    >
      <div role="listbox" aria-label="Ciclos de inscrição">
          ...
          {cycles.map((cycle, i) => {
            ...
            return (
              <button
                ...
                onClick={() => onChange(cycle.cycleId)}
                className={cn(
