...
export function StudentEditConfirmView({ changes, loading, hideHeader, onBack, onConfirm }: Props) {
  return (
    <>
      {!hideHeader && (
      ...
      <div className="flex gap-3">
        ...
        <Button variant="primary" size="sm" fullWidth loading={loading} icon={<Check className="size-4" />} onClick={onConfirm}>
          Confirmar
        </Button>
      </div>
    </>
